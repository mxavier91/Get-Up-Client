...
"Get-Up" is a workout app that is meant to track your daily workouts. Not only can you track workouts you have done, but you can also track to workout you are currently doing, with a bulit in timer.
...
<li>Deploy Apps</li>
<li>API:https://getupworkoutapp.herokuapp.com/</li>
<li>API Repo https://github.com/mxavier91/Get-Up-Api</li>
</ol>
...
There weren't any unsolved issues, I wasn't able to solve the issue with my "Previous Workouts" button. When a user clicks on that button and doesn't have any users, there should be some type notification that tells the user that there isn't any workout, which I need to fix.
...
Wireframe-https://imgur.com/a/Oro8O
User Stories-https://i.imgur.com/kLXprE3.jpg
